...
def eval(model, dataloader, save_path=None, num_batches=None):
    global best_acc
    model.eval()
    correct = 0
    total = 0
...
def evaluate_model_weights(check_point, model_args, save_path=None, num_batches=None):
...
evaluate_model_weights(checkpoint_test, model_args, save_path=save_path, num_batches=1)
