''' Clone of the speechcommands.py from torchaudio.datasets without download capability and adjusted directory to fit our datafolder structure.'''
...
class SPEECHCOMMANDS(Dataset):
    ...
    def __init__(
        ...
        self._path = root ###os.path.join(root, folder_in_archive)
